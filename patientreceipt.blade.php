...
<body>
  ...
  <div class="container" style="display: 1px">
    <h2 align="center" style="color: red">{$data}</h2>
    ...
    <p align="center" flex>
    <span style="color: green">  {{$data['data']['practitioner']['title']}} {{$data['data']['user']}}</span>
      ...
      <p layout="row" flex class="bill-alt-color">
        <span flex="45" layout="row" layout-align="start end" style="color: green">
          Date: {{$data['data']['date_issued'].substr(0,10)}}</span>
          <span flex="50" layout="row" layout-align="end" class="pull-right">
            <span style="color: green">No. <strong class="bill-type" style="color: red">
              {{$data['data']['bill_number']}}</strong></span>
            </span>
          </p>   
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr style="color: red" >
                ...
                <td>{{$charge['items_traded']}}</td>
                <td>{{$charge['amount']}}</td>
              </tr>
              @endforeach
              <tr style="color: red">
                <td colspan="2"><strong>Total </strong></td>
                <td style="text-align:right;min-width:100px;"><strong>{{$data['data']['total']}}</strong></td>
              </tr>
            </tbody>
          </table>
          ...
          <div layout="column"  style="color: green">
            <div layout="row" flex layout-align="start start" class="md-padding">
              ...
              <div flex offset="10"><u><strong>{{$data['data']['total']}}</strong></u></div>
            </div>
